...
```
**Figura 3.3** Ventana Packages - instalación de paquetes
</center>
...
**Figura 3.4** Ventana Terminal - función install.packages
</center>
...
## <span style="color:#034a94">**Paquetes algunos utilizados en Ciencia de Datos**</span>
