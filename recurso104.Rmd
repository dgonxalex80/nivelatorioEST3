...
Se utilizarán tutoriales que permitiran poner a prueba tus conocimientos, por lo que es importante poder estar familiarizados con su carga y activación.
...
learnr::run_tutorial("tutorialU101", "paqueteNIV")   # carga tutorialU101
</pre>
