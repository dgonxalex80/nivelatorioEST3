...
Es recomendable crar un proyecto al inicio con el fin de que todos los codigos, imagenes y demas archivos queden asociados a una carpeta de tal forma que esten disponibles cuando se active el proyecto
...
* **New Directory** : Creamos un nuevo proyecto para lo cual temos varias plantillas
...
```
Para procesar el libro convirtiendolo en formato HTML o pdf se utiliza el boton Build Book ubicado en la ventana Build

```{r, echo=FALSE, out.width="60%", fig.align = "center"}
knitr::include_graphics("img/book3.png")
```
